"""FastAPI application for MoneyPuck Edge Intelligence dashboard."""
...
# ---------------------------------------------------------------------------
# TTLCache (copied verbatim from web_preview.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Helper functions (copied verbatim from web_preview.py)
# ---------------------------------------------------------------------------
...
def _make_params(
    ...
    **extra: str,
    ...
    """Convert FastAPI query params to the dict[str, list[str]] format used by helpers."""
...
def api_odds_history(game_id: str = ""):
    ...
    use_demo = not os.getenv("ODDS_API_KEY", "")
