...
def _build_config(params: dict[str, list[str]]) -> TrackerConfig:
    ...
    return TrackerConfig(
        ...
        home_advantage_pp=_float_param(params, "home_advantage_pp", 2.0),
        market_blend=_float_param(params, "market_blend", 0.2),
        kelly_scale=_float_param(params, "kelly_scale", 0.5),
    )
